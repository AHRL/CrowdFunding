<template>
    <div class="container">
        <el-row class="wrap">
            <div class="sideBar">
                <el-menu class="personMenu" default-active="1" background-color="#5eadc7" text-color="#fff" active-text-color="#ffd04b" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
            ...
            <el-col :span="18" data-content="个人资料">
